...
public class PostController {
    ...
    public ResponseEntity<PostDto> getPostById(@PathVariable Integer postId){
        PostDto postDt=this.postService.getPostById(postId);
...
//this is the url of the paging and also enter the size fom there
//http://localhost:8080/api/posts?pageNumber=9&pageSize=2
